...
const Profile = () => {
  ...
  return (
    <div className="max-w-md">
      ...
      <h2 className="text-sm font-medium mb-1">Your profile</h2>
      <p className="text-xs text-gray-400 mb-8">
        {profile.intent === "condition" ? `Condition: ${profile.conditions[0]}` : profile.intent === "goal" ? `Goal: ${profile.goals[0]}` : "Exploring"}
      </p>

      <h3 className="text-xs font-medium mb-3">Foods to avoid</h3>
      <p className="text-xs text-gray-400 mb-4">Click a tag to remove it.</p>
